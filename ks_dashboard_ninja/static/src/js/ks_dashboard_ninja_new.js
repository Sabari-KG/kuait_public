...
import { Component,onRendered,  onWillStart, useState ,onMounted, onWillRender, useRef, useEffect,onWillUnmount  } from "@odoo/owl";
            ...
            confirm: () => {
                this._rpc("/web/dataset/call_kw/ks.dashboard.delete.wizard/ks_delete_record", {
                    ...
                    kwargs: {dashboard_id: dashboard_id}
                        ...
                        self.env.services.menu.selectMenu(result).then(()=>{
...
KsDashboardNinja.components = { Ksdashboardtile, Ksdashboardlistview, Ksdashboardgraph, Ksdashboardkpiview, Ksdashboardtodo, DateTimePicker, DateTimeInput,KschatwithAI};
